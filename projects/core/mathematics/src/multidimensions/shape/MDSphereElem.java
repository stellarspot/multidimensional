...
public class MDSphereElem implements IMDShapeElem {
    ...
    public MDSphereElem(int dim, double d, int M) {
        this.dim = dim;
        this.d = d;
        this.M = M;
        init();
...
//        System.out.println("back: " + toString(back));
        ...
        //ICMDVector[] vertices = new ICMDVector[NM];
...
//        System.out.println("res: " + toString(result));
    ...
    static class MDSegment implements Segment {
